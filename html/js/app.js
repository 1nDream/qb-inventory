            ...
            if (ItemData.name.split("_")[0] == "weapon") {
                if (!$("#weapon-attachments").length) {
                    ...
                    $(".inv-options-list").append(
                        '<div class="inv-option-item" id="weapon-attachments"><p>Attacments</p></div>'
                    );
...
(() => {
    ...
    Inventory.ToggleHotbar = function(data) {
        if (data.open) {
            ...
            var elem =
                '<div class="z-hotbar-item-slot" data-zhotbarslot="41"> <div class="z-hotbar-item-slot-key"><p>6 <i style="top: 1vw; left: -0.2vw;" class="fas fa-lock"></i></p></div><div class="z-hotbar-item-slot-img"></div><div class="z-hotbar-item-slot-label"><p>&nbsp;</p></div></div>';
            $(".z-hotbar-inventory").append(elem);
                ...
                if (item != null) {
                    ...
                    if (item.slot == 41) {
                        $(".z-hotbar-inventory")
                            .find("[data-zhotbarslot=" + item.slot + "]")
                            .html(
                                '<div class="z-hotbar-item-slot-key"><p>6 <i style="top: 1vw; left: -0.2vw;" class="fas fa-lock"></i></p></div><div class="z-hotbar-item-slot-img"><img src="images/' +
                                item.image +
                                '" alt="' +
                                item.name +
    ...
    Inventory.itemBox = function(data) {
        ...
        var type = "Use " + data.itemAmount + "x";
        if (data.type == "add") {
          type = "Add " + data.itemAmount + "x";
        } else if (data.type == "remove") {
          type = "Remove " + data.itemAmount + "x";
        }
